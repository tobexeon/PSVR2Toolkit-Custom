...
#define STEAMVR_SETTINGS_ENABLE_STEAMVR_BRIGHTNESS "enableSteamVRBrightness"
...
#define STEAMVR_SETTINGS_HAPTICS_LOW_FREQ_OVERDRIVE "hapticsLowFreqOverdrive"

#define SETTING_ENABLE_EYELID_ESTIMATION_DEFAULT_VALUE false
#define SETTING_ENABLE_STEAMVR_BRIGHTNESS_DEFAULT_VALUE false
...
#define SETTING_HAPTICS_LOW_FREQ_OVERDRIVE_DEFAULT_VALUE false // 默认为开启，保持原有体验
